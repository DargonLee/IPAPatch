...
+ (void)passHTTPS1 {
     ...
     */
    bgl_exchangeMethod(NSClassFromString(@"AFSecurityPolicy"), NSSelectorFromString(@"setSSLPinningMode:"), [HookTools class], @selector(sslPinningMode:), NSSelectorFromString(@"setSSLPinningMode:"));
    bgl_exchangeMethod(NSClassFromString(@"AFSecurityPolicy"), NSSelectorFromString(@"setAllowInvalidCertificates:"), [HookTools class], @selector(allowInvalid:), NSSelectorFromString(@"setAllowInvalidCertificates:"));
    bgl_exchangeMethod(NSClassFromString(@"AFSecurityPolicy"), NSSelectorFromString(@"setValidatesDomainName:"), [HookTools class], @selector(validatesDomainName:), NSSelectorFromString(@"setAllowInvalidCertificates:"));
}
...
+ (void)passHTTPS2 {
     ...
     */
    bgl_exchangeMethod(NSClassFromString(@"AFHTTPSessionManager"), NSSelectorFromString(@"setSecurityPolicy:"), [HookTools class], @selector(securityPolicy:), NSSelectorFromString(@"setSecurityPolicy:"));
}
...
+ (void)exchangeStringByAppendingString {
    bgl_exchangeMethod([NSString class], NSSelectorFromString(@"stringByAppendingString:"), [HookTools class], @selector(myStringByAppendingString:),  NSSelectorFromString(@"stringByAppendingString:"));
}
...
+ (void)exchangeAppendString {
    bgl_exchangeMethod([NSMutableString class], NSSelectorFromString(@"appendString:"), [HookTools class], @selector(myMutableStringAppendString:), NSSelectorFromString(@"appendString:"));
}
